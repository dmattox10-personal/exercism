...
public class GigasecondTest {
    ...
    public void modernTime() {
        Gigaseconds gigaSecond = new Gigaseconds(LocalDate.of(2011, Month.APRIL, 25));
    ...
    public void afterEpochTime() {
        Gigaseconds gigaSecond = new Gigaseconds(LocalDate.of(1977, Month.JUNE, 13));
    ...
    public void beforeEpochTime() {
        Gigaseconds gigaSecond = new Gigaseconds(LocalDate.of(1959, Month.JULY, 19));
    ...
    public void withFullTimeSpecified() {
        Gigaseconds gigaSecond = new Gigaseconds(LocalDateTime.of(2015, Month.JANUARY, 24, 22, 0, 0));
    ...
    public void withFullTimeSpecifiedAndDayRollover() {
        Gigaseconds gigaSecond = new Gigaseconds(LocalDateTime.of(2015, Month.JANUARY, 24, 23, 59, 59));
